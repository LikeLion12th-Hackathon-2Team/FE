...
function NaverButton() {
    ...
    const NAVER_AUTH_URL = `https://nid.naver.com/oauth2.0/authorize?response_type=code&client_id=X9wShuIX0XXcW2_LlG93&state=hLiDdL2uhPtsftcU&redirect_uri=http://localhost:3000/naverLogin`;
